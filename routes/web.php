...
Route::get('article/{id}', [App\Http\Controllers\ArticalController::class, 'show_artical'])->name('show.artical')->middleware('check.article.limit');


//Route::get('search', [App\Http\Controllers\ArticalController::class, 'search'])->name('search');
...
Route::get('magazine/{id}', [App\Http\Controllers\MagazineController::class, 'show'])->name('show.magazines')->middleware('CheckSubscription');
...
Route::get('certifiicate', [App\Http\Controllers\CertificateController::class, 'userCertificate'])->name('certificate');
...
Route::middleware('isLoginAdmin')->group(function()
{
    ...
    Route::get('portal/certifiicate', [App\Http\Controllers\CertificateController::class, 'allcertificate'])->name('allcertificate');
    Route::get('portal/certifiicate/add', [App\Http\Controllers\CertificateController::class, 'addcertficate'])->name('addcertficate');
    Route::post('portal/certifiicate/create/done', [App\Http\Controllers\CertificateController::class, 'uploadCertificate'])->name('add.done.certificate');
