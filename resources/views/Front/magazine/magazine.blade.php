                            ...
                            <nav class="mainmenu-nav">
                                <ul class="mainmenu">
                                    <li class="has-droupdown">
                                        @foreach($categoryOfArticles as $categoryOfArticle)
                                        <a href="#">الاقسام<i class="icon-1"></i></a>
                                        <ul class="submenu">
                                            <li><a href="{{route('articles.index',['category' => $categoryOfArticle->id])}}">{{$categoryOfArticle->name}}</a></li>
                                        </ul>
                                        @endforeach
                                    </li>
                                </ul>
                            ...
                            <div class="inner">
                                <div class="thumbnail">
                                    <a href="{{route('show.magazines',$magazine->id)}}">
                                        <img src="{{ asset('/storage/magazine/' . $magazine->photo) }}" alt="Blog Images" style="
                                        height: 150px;
                                        width : 250px">
                                    </a>
                                </div>
