                    ...
                    <div class="header-mainnav">
                        <nav class="mainmenu-nav">
                            <ul class="mainmenu">
                                ...
                                <li><a href="{{route('home_elms')}}">الدورات</a>
                                </li>
            ...
            <div class="row row--30">
                <div class="col-lg-8">
                    ...
                    <div class="edu-blog blog-style-list" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="inner">
                            <div class="thumbnail">
                                <a href="{{asset('storage/certificate/'. $certificate->file)}}">
                            ...
                            <div class="content">
                                <h5 class="title"><a href="{{asset('storage/certificate/'. $certificate->file)}}" > {{ $certificate->course->name }} شهادة</a></h5>
